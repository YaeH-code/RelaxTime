...
<div class="container">
    <form class="vstack gap-3" method="POST" action="<?= URL ?>admin/admv">
      ...
      <input type="text" class="form-control" placeholder="Password(8 Numbers)" aria-label="default input example" aria-describedby="button-addon2" name="password" value="<?= $user->getPassword() ?>">
